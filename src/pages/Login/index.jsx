...
function Login() {
  ...
  const loginFunction = async (state) => {
    try {
      const x = await axios.post("http://localhost:3001/login", {
  ...
  return (
    <div className="flex flex-row-reverse items-center justify-center w-full h-screen bg-gradient-to-tr from-blue-900 to-blue-500">
      <div
        ...
        className="z-10 flex flex-col items-center w-full mx-3 overflow-hidden bg-blue-600 bg-center bg-cover rounded shadow-md bg-image sm:w-1/2 md:w-9/12 lg:w-1/2 md:mx-5 lg:mx-0 md:flex-row"
      >
